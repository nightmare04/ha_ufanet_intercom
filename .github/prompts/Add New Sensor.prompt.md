...
- Create new sensor file in `custom_components/ufanet_intercom/sensor/`
- Inherit from `UfanetIntercomEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Ufanet intercom integration."""
...
class UfanetIntercom[SensorName]Sensor(
...
- Entity: `custom_components/ufanet_intercom/sensor/[sensor_name].py`
- Platform: `custom_components/ufanet_intercom/sensor/__init__.py`
- Translations: `custom_components/ufanet_intercom/translations/*.json`
