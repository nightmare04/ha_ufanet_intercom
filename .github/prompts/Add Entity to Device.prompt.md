...
- Inherit from `UfanetIntercomEntity` and platform base class
...
- Entity: `custom_components/ufanet_intercom/[platform]/[entity_name].py`
- Platform: `custom_components/ufanet_intercom/[platform]/__init__.py`
