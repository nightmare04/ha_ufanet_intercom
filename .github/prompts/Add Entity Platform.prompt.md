...
**Directory:** `custom_components/ufanet_intercom/[platform]/`
...
```python
"""[Platform] platform for Ufanet intercom integration."""
...
from .entity import UfanetIntercomEntity
from .[entity_file] import UfanetIntercom[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: UfanetIntercomDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            UfanetIntercom[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Ufanet intercom integration."""
...
class UfanetIntercom[EntityName](
    UfanetIntercomEntity,
    [PlatformEntityClass],
):
...
Add platform to `custom_components/ufanet_intercom/manifest.json`:
...
- [ ] Entity class inherits from both `UfanetIntercomEntity` and platform class
...
- **Class prefix:** `UfanetIntercom`
- **Base entity:** `UfanetIntercomEntity` in `entity/base.py`
- **Coordinator:** `UfanetIntercomDataUpdateCoordinator`
