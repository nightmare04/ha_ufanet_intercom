...
**File:** `custom_components/ufanet_intercom/services.yaml`
...
Create `custom_components/ufanet_intercom/service_actions/[action_name].py`:

```python
"""[Action name] service action for Ufanet intercom integration."""
...
**File:** `custom_components/ufanet_intercom/__init__.py`
...
**File:** `custom_components/ufanet_intercom/const.py`
...
3. Find service action: `ufanet_intercom.[action_name]`
...
- **Service actions directory:** `custom_components/ufanet_intercom/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/ufanet_intercom/services.yaml` (legacy filename)
- **Icons:** `custom_components/ufanet_intercom/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/ufanet_intercom/translations/*.json` under `services` key (legacy)
