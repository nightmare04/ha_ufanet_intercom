...
- `entity/` - Base entity class (`UfanetIntercomEntity`)
...
- All entities inherit: `(PlatformEntity, UfanetIntercomEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.ufanet_intercom: debug` in `config/configuration.yaml`
