...
- `UfanetIntercomApiClientError` (Base)
- `UfanetIntercomApiClientCommunicationError` (Network, timeout, HTTP errors)
- `UfanetIntercomApiClientAuthenticationError` (401, 403, invalid credentials)
