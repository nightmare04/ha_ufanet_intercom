...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/nightmare04/ha_ufanet_intercom?quickstart=1)
...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=ha_ufanet_intercom&category=integration)
...
1. Download the `custom_components/ufanet_intercom/` folder from this repository
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=ufanet_intercom)

Follow the setup wizard:

1. Enter your contract
...
1. Go to **Settings** → **Devices & Services**
2. Find **Ufanet intercom integration**
...
Find all entities in **Settings** → **Devices & Services** → **Ufanet intercom integration** → click on the device.
...
### `ufanet_intercom.example_action`
...
```yaml
service: ufanet_intercom.example_action
data:
  # Add your parameters here
```

### `ufanet_intercom.reload_data`
...
```yaml
service: ufanet_intercom.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Ufanet intercom integration → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@nightmare04][user_profile]**

---

[commits-shield]: https://img.shields.io/github/commit-activity/y/nightmare04/ha_ufanet_intercom.svg?style=for-the-badge
[commits]: https://github.com/nightmare04/ha_ufanet_intercom/commits/main
[hacs]: https://github.com/hacs/integration
[hacsbadge]: https://img.shields.io/badge/HACS-Default-orange.svg?style=for-the-badge
[license-shield]: https://img.shields.io/github/license/nightmare04/ha_ufanet_intercom.svg?style=for-the-badge
[maintenance-shield]: https://img.shields.io/badge/maintainer-%40nightmare04-blue.svg?style=for-the-badge
[releases-shield]: https://img.shields.io/github/release/nightmare04/ha_ufanet_intercom.svg?style=for-the-badge
[releases]: https://github.com/nightmare04/ha_ufanet_intercom/releases
