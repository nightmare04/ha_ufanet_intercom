"""
Core DataUpdateCoordinator implementation for ufanet_intercom.
...
from custom_components.ufanet_intercom.const import LOGGER
...
class UfanetIntercomDataUpdateCoordinator(DataUpdateCoordinator):
    """
    ...
    config_entry: UfanetIntercomConfigEntry
    ...
    async def _async_update_data(self) -> Any:
        ...
        except UfanetIntercomApiClientAuthenticationError as exception:
            LOGGER.warning("Authentication error - %s", exception)
            raise ConfigEntryAuthFailed(
                translation_domain="ufanet_intercom",
                translation_key="authentication_failed",
            ) from exception
        except UfanetIntercomApiClientError as exception:
