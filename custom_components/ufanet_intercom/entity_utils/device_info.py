"""Device info utilities for ufanet_intercom."""
...
def create_device_info(
    ...
    return DeviceInfo(
        ...
        name=name or "Ufanet intercom integration",
        manufacturer=manufacturer or "Ufanet intercom integration",
...
def get_device_identifiers(config_entry: ConfigEntry) -> set[tuple[str, str]]:
    ...
    Example:
        ...
        >>> # Returns: {('ufanet_intercom', 'entry_id_value')}
    """
