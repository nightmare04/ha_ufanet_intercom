"""
Config flow for ufanet_intercom.
...
from custom_components.ufanet_intercom.config_flow_handler.schemas import (
    get_reauth_schema,
    get_reconfigure_schema,
    get_user_schema,
)
from custom_components.ufanet_intercom.config_flow_handler.validators import validate_credentials
from custom_components.ufanet_intercom.const import DOMAIN, LOGGER
from homeassistant import config_entries
from homeassistant.const import CONF_PASSWORD, CONF_USERNAME

if TYPE_CHECKING:
    from custom_components.ufanet_intercom.config_flow_handler.options_flow import UfanetIntercomOptionsFlow

# Map exception types to error keys for user-facing messages
ERROR_MAP = {
    "UfanetIntercomApiClientAuthenticationError": "auth",
    "UfanetIntercomApiClientCommunicationError": "connection",
}


class UfanetIntercomConfigFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """
    Handle a config flow for ufanet_intercom.
    ...
    def async_get_options_flow(
        ...
        """
        from custom_components.ufanet_intercom.config_flow_handler.options_flow import (  # noqa: PLC0415
            UfanetIntercomOptionsFlow,
        )
...
__all__ = ["UfanetIntercomConfigFlowHandler"]
