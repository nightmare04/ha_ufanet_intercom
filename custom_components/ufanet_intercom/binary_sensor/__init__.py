...
from .connectivity import ENTITY_DESCRIPTIONS as CONNECTIVITY_DESCRIPTIONS, UfanetIntercomConnectivitySensor
from .filter import ENTITY_DESCRIPTIONS as FILTER_DESCRIPTIONS, UfanetIntercomFilterSensor
...
async def async_setup_entry(
    ...
    connectivity_entities = [
        UfanetIntercomConnectivitySensor(
