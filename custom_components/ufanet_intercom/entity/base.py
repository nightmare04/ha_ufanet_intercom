"""
Base entity class for ufanet_intercom.
...
from custom_components.ufanet_intercom.const import ATTRIBUTION
...
class UfanetIntercomEntity(CoordinatorEntity[UfanetIntercomDataUpdateCoordinator]):
    """
    Base entity class for ufanet_intercom.
