...
from .air_quality import ENTITY_DESCRIPTIONS as AIR_QUALITY_DESCRIPTIONS, UfanetIntercomAirQualitySensor
from .diagnostic import ENTITY_DESCRIPTIONS as DIAGNOSTIC_DESCRIPTIONS, UfanetIntercomDiagnosticSensor
...
async def async_setup_entry(
    ...
    async_add_entities(
        UfanetIntercomAirQualitySensor(
    ...
    async_add_entities(
        UfanetIntercomDiagnosticSensor(
            coordinator=entry.runtime_data.coordinator,
            entity_description=entity_description,
        )
